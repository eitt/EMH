...
\input{../tables/generated/tab_summary_statistics.tex}
\input{../tables/generated/tab_diagnostics.tex}
\input{../tables/generated/tab_return_correlations.tex}
...
\input{../tables/generated/tab_rmse_by_config.tex}
\input{../tables/generated/tab_model_performance_summary.tex}
...
Diffusion forecasts are substantially worse than benchmark models in this implementation. Average RMSE for diffusion is approximately 0.47--0.64 across configurations, versus approximately 0.02 for \(H=1\) random-walk benchmarks and approximately 0.046 for \(H=5\) random-walk benchmarks (\Cref{tab:rmse-by-config}).

\subsection{Formal Comparative Inference}
\input{../tables/generated/tab_dm_summary.tex}
...
\Cref{tab:dm-summary,fig:dm-pvalue} confirms that diffusion is significantly worse than random walk in all six configurations under DM tests. Some baseline models are statistically indistinguishable from random walk at \(H=5\), while ridge and MLP are typically inferior.
...
\input{../tables/generated/tab_xai_seed_sensitivity.tex}
\input{../tables/generated/tab_xai_stability.tex}
...
\input{../tables/generated/tab_robustness_summary.tex}
\input{../tables/generated/tab_diffusion_ablation.tex}
\input{../tables/generated/tab_diffusion_seed_sensitivity.tex}
