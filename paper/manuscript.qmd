...
The manuscript contribution is therefore methodological transparency: explicit target construction, boundary-safe validation for multi-day horizons, joint model-comparison inference, and disciplined separation of descriptive/XAI diagnostics from econometric forecast evidence. Stronger claims require a fuller robustness program before journal submission.
